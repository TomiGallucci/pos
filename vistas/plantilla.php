...
<head>
  ...
  <link rel="stylesheet" href="vistas/css/layout.css">
   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         ...
         $_GET["ruta"] == "crear-reparacion" ||
         $_GET["ruta"] == "editar-reparacion" ||
         $_GET["ruta"] == "reportes-reparacion" ||
         $_GET["ruta"] == "salir"){
