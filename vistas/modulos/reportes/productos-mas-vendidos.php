...
<div class="box box-default">
  ...
  <div class="box-body">
        ...
        <div class="chart-responsive">
                ...
                <canvas id="pieCharts" height="150"></canvas>
        ...
        <div class="col-md-5">
          ...
          <?php
            count($productos) < 10 ? $contador = count($productos) : $contador = 10;
    ...
    <ul class="nav nav-pills nav-stacked">
       ...
       <?php
       count($productos) < 5 ? $contador = count($productos) : $contador = 5;
            for($i = 0; $i < $contador ; $i++){
              if($productos[$i]["ventas"] != 0){
               echo '<li>
                       ...
                       <a>
                         ...
                         + '.ceil($productos[$i]["ventas"]*100/$totalVentas["total"]-0.5).'%
                         </span>
