...
class ModeloClientes{
	...
	var_dump($datos);
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre,documento,email,telefono,celular,direccion,fecha_nacimiento) VALUES(:nombre,:documento,:email,:telefono,:celular,:direccion,:fecha_nacimiento)");
	...
	$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, documento = :documento,
